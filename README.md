...
- `evaluation/faithfulness_metrics.json`
...
현재 Calculator Tool과 Policy Lookup Tool은 규칙 기반 routing 방식으로 동작하며, 향후 실제 LLM Function Calling 방식으로 확장할 예정입니다.

현재 Faithfulness 평가는 LLM 기반 평가가 아닌 질문과 검색 문서의 키워드 겹침을 이용한 간단한 근사 평가 방식입니다.
